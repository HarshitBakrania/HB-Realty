          ...
          <div className="lg:col-span-1 px-4 sm:px-8 md:px-10 lg:px-14 py-8 lg:py-10 border-t border-slate-600 lg:border-t-0">
            ...
            <div className="grid grid-cols-2 gap-3">
              {[
                ...
                {
                  label: "Property",
                  value: capitalizeFirstLetter(post.property),
                },
                {
                  label: "Furnished",
                  value: post.postDetail.utilities === "Yes" ? "Yes" : "No",
                },
                { label: "Pets", value: post.postDetail.pet },
              ].map(({ label, value }) => (
                <div
                  key={label}
                  className="bg-white/5 border border-white/10 rounded-xl p-3 sm:p-4 flex flex-col gap-1"
                >
                  ...
                  <div className="flex items-center gap-3 px-4 py-3">
                    ...
                    <div>
                      ...
                      <div className="text-sm sm:text-base font-medium">
                        {post.postDetail.size?.toLocaleString()} sq ft
                      </div>
                    </div>
                  </div>
                  <div className="flex items-center gap-3 px-4 py-3">
                  ...
                  {[
                    {
                      icon: <SchoolIcon />,
                      label: "School",
                      dist: post.postDetail.school,
                    },
                    {
                      icon: <HospitalIcon />,
                      label: "Hospital",
                      dist: post.postDetail.hospital,
                    },
                    {
                      icon: <RestaurantIcon />,
                      label: "Restaurant",
                      dist: post.postDetail.restaurant,
                    },
                  ].map(({ icon, label, dist }) => (
                    <div
                      key={label}
